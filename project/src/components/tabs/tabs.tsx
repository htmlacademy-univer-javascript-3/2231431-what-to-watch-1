      ...
      <nav className="film-nav film-card__nav">
        <ul className="film-nav__list">
          <li className={selectedTab === TabNames.Overview ? 'film-nav__item film-nav__item--active' : 'film-nav__item'}>
            <button
              className="reset-default-button-style film-nav__link" onClick={() => setSelectedTab(TabNames.Overview)}
          ...
          <li className={selectedTab === TabNames.Details ? 'film-nav__item film-nav__item--active' : 'film-nav__item'}>
            <button
              className="reset-default-button-style film-nav__link" onClick={() => setSelectedTab(TabNames.Details)}
          ...
          <li className={selectedTab === TabNames.Reviews ? 'film-nav__item film-nav__item--active' : 'film-nav__item'}>
            <button
              className="reset-default-button-style film-nav__link" onClick={() => setSelectedTab(TabNames.Reviews)}
